...
- **FE**: grouping UI elements by category, form validation error collection, component registry by
  type
- **BE**: grouping items by key, counting occurrences, building adjacency lists, log aggregation by
  level, request grouping by endpoint
